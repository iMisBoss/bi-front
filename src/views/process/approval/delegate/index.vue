...
const tableData = ref([
  // 我发起的委托（张三发起）
  {
    ...
    submitTime: '2026-01-15 08:50:00',
    confirmTime: '2026-01-15 09:00:00',
    remark: '休假期间委托处理日常审批'
  },
  {
    id: 2,
    delegateNo: 'WT20260114001',
    trusteeName: '王五',
    delegatorName: '张三',
    scope: '采购申请流程、费用报销流程',
    ...
    submitTime: '2026-01-14 08:30:00',
    confirmTime: null,
  ...
  },
  {
    ...
    delegatorName: '张三',
    scope: '会议申请流程',
    startTime: '2026-01-13 09:00',
    endTime: '2026-01-20 18:00',
  ...
  {
    id: 4,
    delegateNo: 'WT20260112001',
    trusteeName: '钱七',
    delegatorName: '张三',
    scope: '人事调动流程',
    startTime: '2026-01-12 09:00',
    endTime: '2026-01-19 18:00',
    status: 'waiting',
    confirmStatus: 'confirmed',
    submitTime: '2026-01-12 08:00:00',
    confirmTime: '2026-01-12 10:00:00',
    remark: '已同意但尚未到生效时间'
  },
  {
    id: 5,
    delegateNo: 'WT20260111001',
    trusteeName: '孙八',
    delegatorName: '张三',
    scope: '用印申请流程',
    startTime: '2026-01-11 09:00',
    endTime: '2026-01-18 18:00',
    status: 'rejected',
    confirmStatus: 'rejected',
    submitTime: '2026-01-11 08:00:00',
    confirmTime: null,
    rejectReason: '时间冲突，无法接受',
    rejectTime: '2026-01-11 10:00:00',
    remark: '被受托人拒绝'
  },
  {
    id: 6,
    delegateNo: 'WT20260110001',
    trusteeName: '周九',
    delegatorName: '张三',
    scope: '车辆申请流程',
    startTime: '2026-01-10 09:00',
    endTime: '2026-01-17 18:00',
    status: 'cancelled',
    confirmStatus: 'confirmed',
    submitTime: '2026-01-10 08:00:00',
    confirmTime: '2026-01-10 09:00:00',
    remark: '委托人主动撤销'
  },
  ...
  {
    id: 7,
    delegateNo: 'WT20260109001',
    trusteeName: '张三',
    delegatorName: '吴十',
    scope: '加班申请流程',
    startTime: '2026-01-09 09:00',
    endTime: '2026-01-10 18:00',
    status: 'pending',
    confirmStatus: 'waiting',
    submitTime: '2026-01-09 08:00:00',
    confirmTime: null,
    remark: '家中有事，委托处理加班审批'
  },
  {
    id: 8,
    delegateNo: 'WT20260108001',
    trusteeName: '张三',
    delegatorName: '郑十一',
    scope: '考勤审批流程',
    startTime: '2026-01-08 09:00',
    endTime: '2026-01-09 18:00',
    status: 'pending',
    confirmStatus: 'waiting',
    submitTime: '2026-01-08 08:00:00',
    confirmTime: null,
    remark: '生病请假，委托处理考勤异常'
  },
  {
    id: 9,
    delegateNo: 'WT20260107001',
    trusteeName: '张三',
    delegatorName: '王十二',
    scope: '付款申请流程',
    startTime: '2026-01-07 09:00',
    endTime: '2026-01-14 18:00',
    status: 'active',
    confirmStatus: 'confirmed',
    submitTime: '2026-01-07 08:00:00',
    confirmTime: '2026-01-07 09:30:00',
    remark: '出国考察，委托处理紧急付款'
  },
  {
    id: 10,
    delegateNo: 'WT20260106001',
    trusteeName: '张三',
    delegatorName: '冯十三',
    scope: '合同审批流程',
    startTime: '2026-01-06 09:00',
    endTime: '2026-01-13 18:00',
    status: 'rejected',
    confirmStatus: 'rejected',
    submitTime: '2026-01-06 08:00:00',
    confirmTime: null,
    rejectReason: '对合同条款不熟悉，无法审批',
    rejectTime: '2026-01-06 10:00:00',
    remark: '专业领域不符，建议找法务同事'
  },
  {
    id: 11,
    delegateNo: 'WT20260105001',
    trusteeName: '张三',
    delegatorName: '陈十四',
    scope: '项目立项流程',
    startTime: '2026-01-05 09:00',
    endTime: '2026-01-12 18:00',
    status: 'pending',
    confirmStatus: 'waiting',
    submitTime: '2026-01-05 08:00:00',
    confirmTime: null,
    remark: '参加封闭培训，委托处理项目审批'
  },
  {
    id: 12,
    delegateNo: 'WT20260104001',
    trusteeName: '张三',
    delegatorName: '褚十五',
    scope: '费用报销流程',
    startTime: '2026-01-04 09:00',
    endTime: '2026-01-11 18:00',
    status: 'active',
    confirmStatus: 'confirmed',
    submitTime: '2026-01-04 08:00:00',
    confirmTime: '2026-01-04 09:00:00',
    remark: '产假期间，委托处理日常报销'
  },
  {
    id: 13,
    delegateNo: 'WT20260103001',
    trusteeName: '张三',
    delegatorName: '卫十六',
    scope: '采购申请流程',
    startTime: '2026-01-03 09:00',
    endTime: '2026-01-10 18:00',
    status: 'void',
    confirmStatus: 'void',
    submitTime: '2026-01-03 08:00:00',
    confirmTime: null,
    remark: '超过生效时间未确认，系统自动作废'
  },
  {
    id: 14,
    delegateNo: 'WT20260102001',
    trusteeName: '张三',
    delegatorName: '蒋十七',
    scope: '全部审批流程',
    ...
    status: 'expired',
    confirmStatus: 'confirmed',
    submitTime: '2026-01-02 08:00:00',
    confirmTime: '2026-01-02 09:00:00',
