        ...
        <el-row :gutter="40">
          ...
          <el-col :span="8">
            <el-form-item label="保留份数">
              <el-input-number v-model="backupConfig.keepCount" :min="1" :max="30" style="width: 100%" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
        ...
        <el-row :gutter="40">
          ...
          <el-col :span="6">
            <el-form-item label="重试次数">
              <el-input-number v-model="backupConfig.retryCount" :min="1" :max="5" :disabled="!backupConfig.autoRetry" style="width: 100%" />
            </el-form-item>
          </el-col>
          <el-col :span="6">
