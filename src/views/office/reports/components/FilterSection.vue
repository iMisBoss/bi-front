      ...
      <div class="filter-header">
        ...
        <div class="filter-actions">
          ...
          <el-dropdown @command="handleLoadTemplate">
            <el-button link type="primary">加载模板</el-button>
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="5">
          <el-form-item label="流程模板">
            <el-select v-model="filterForm.templates" placeholder="全流程" multiple collapse-tags style="width: 100%">
        ...
        <el-col :span="5">
          <el-form-item label="流程编号">
            <el-input v-model="filterForm.processNo" placeholder="精准查询" clearable />
          </el-form-item>
        </el-col>
        <el-col :span="5">
          <el-form-item label="发起人">
            <el-input v-model="filterForm.initiator" placeholder="姓名/工号" clearable />
          </el-form-item>
        </el-col>
        <el-col :span="5">
          <el-form-item label="审批人">
            <el-input v-model="filterForm.approver" placeholder="当前/历史" clearable />
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <el-form-item label="组织架构">
            <el-select v-model="filterForm.departments" placeholder="全公司" multiple collapse-tags style="width: 100%">
        ...
        <el-col :span="6">
          <el-form-item label="异常流程">
            <el-select v-model="filterForm.abnormalType" placeholder="全部" multiple collapse-tags style="width: 100%">
        ...
        <el-col :span="6">
          <el-form-item label="数据范围">
            <el-select v-model="filterForm.dataScope" placeholder="全部数据" style="width: 100%">
